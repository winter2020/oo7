...
unsigned char get_taint_source();

int __isoc99_fscanf(FILE * restrict stream, const char * restrict format, void *arg1, void *arg2, void *arg3) __attribute__((format(scanf,2,3)));
int tfscanf(FILE * restrict stream, const char * restrict format, void *arg1, void *arg2, void *arg3) __attribute__((format(scanf,2,3)));
...
unsigned short * __errno_location(void);
